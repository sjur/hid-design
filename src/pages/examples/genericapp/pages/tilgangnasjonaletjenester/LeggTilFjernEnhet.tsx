...
const LeggTilFjernEnhet = () => {
  const [showSearchResults, useShowSearchResults] = useState(false);
  const [showSelectedResults, useShowSelectedResults] = useState(true);
  const [showSelected2Results, useShowSelected2Results] = useState(true);
    ...
    <Row>
      <Col lg={4}>
        <Segment bgColor={palette.c000} hSpace="0">
          <Heading size="h4" text="Søk etter nye enheter" compact />
          <StyledRow>
            <Col lg={12}>
              <Input
      ...
      <Col lg={8}>
        <Segment vSpace="0.5rem" hSpace="1rem">
          <Row>
            <StyledCol lg={6}>
              <Heading size="h2" text="Enheter" compact />
            </StyledCol>
            <StyledCol lg={6}>
              {/* <ButtonContainer> */}
              <ButtonGroup>
                <Button
                  label="OK, lagre endringer"
                  small
                  buttonType={
...
export default LeggTilFjernEnhet;
